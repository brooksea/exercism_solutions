...
export class TranslationService {
  ...
  premium(text, minimumQuality) {
    const retry = () => this.api.fetch(text).then(({ translation , quality }) => {
      if (quality >= minimumQuality) {
        console.log(quality, minimumQuality)
        return translation
      } else {
      ...
      return this.request(text).then(retry)
    })
